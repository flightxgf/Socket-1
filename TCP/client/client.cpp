/*
	Content:Linux Network Programming Using Socket(TCP) in client
	Author:scottshi
    Date:2016/08/31
*/
...
int main(int argc, char **argv)
{
	...
	//Initialize client socket,including address protocal,host and port
	...
	//Use internet stream protocal(TCP) to create client socket
	...
	//Use server socket to make a connection
